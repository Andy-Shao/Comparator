...
APP_LOG=${LOG_PATH}/analyse_differentResultLine.log
...
java -cp $CLASSPATH $JVM_ARGS $LOG4J $system_arg comparator.action.AnalyseDifferentResult $filePath $type classpath:comparator/analyse/analyseDifferentResultLineVisitor.xml