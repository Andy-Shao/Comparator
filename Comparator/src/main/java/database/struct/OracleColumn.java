...
public class OracleColumn implements Column {
	...
	public void setTypeByStr(String type) {
		...
		else if (type.equalsIgnoreCase("TIMESTAMP")) this.type = java.sql.Timestamp.class;
	...
	public int compareTo(Column o) {
		if (!(o instanceof OracleColumn)) throw new IllegalArgumentException("the o isn't " + OracleColumn.class);
		OracleColumn that = (OracleColumn) o;
		return this.location - that.location;
	}

	@Override
	public String toString() {
		return "OracleColumn [location=" + location + ", name=" + name + ", type=" + type + "]";
	}
}
