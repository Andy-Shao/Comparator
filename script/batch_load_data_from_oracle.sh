...
APP_LOG=${LOG_PATH}/batch_load_data_from_oracle.log
...
contextPathes=classpath:datasource/oracleDataSource.xml#classpath:database/struct/OracleTableFactory.xml#${contextPathes}
