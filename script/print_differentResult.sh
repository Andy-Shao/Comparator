...
APP_LOG=${LOG_PATH}/print_differentResult.log
...
java -cp $CLASSPATH $JVM_ARGS $LOG4J $system_arg comparator.action.AnalyseDifferentResult $filePath $type classpath:comparator/analyse/printDifferentResultVisitor.xml